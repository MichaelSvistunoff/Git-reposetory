...
!function() {
    ...
    r = function(e) {
        20 < e.currentTarget.pageYOffset ? (a.classList.add("navbar-stuck"),
        a.classList.contains("navbar-ignore-dark-mode") && a.classList.remove("ignore-dark-mode")) : (a.classList.remove("navbar-stuck"),
        a.classList.contains("navbar-ignore-dark-mode") && a.classList.add("ignore-dark-mode"))
    }
    ,
    ...
    null != (i = document.querySelector(".btn-scroll-top")) && (n = parseInt(450, 10),
    ...
    function() {
        for (var e = document.querySelectorAll(".swiper"), t = function(e, t) {
            (a = null != t.dataset.swiperOptions ? JSON.parse(t.dataset.swiperOptions) : a).thumbnails && (r = a.thumbnails.images,
            a = Object.assign({}, a, {
                pagination: {
                    el: a.thumbnails.el,
                    clickable: !0,
            ...
            a.controlledSlider && (null != (o = document.querySelector(a.controlledSlider)).dataset.swiperOptions && (n = JSON.parse(o.dataset.swiperOptions)),
            o = new Swiper(o,n),
            t.controller.control = o),
            a.bindedContent && t.on("activeIndexChange", function(e) {
    ...
    function() {
        ...
        if (0 !== e.length)
            for (var t = 0; t < e.length; t++) {
                var r = void 0
                  , a = (null != e[t].dataset.datepickerOptions && (r = JSON.parse(e[t].dataset.datepickerOptions)),
        ...
        if (0 !== a.length)
            for (var e = 0; e < a.length; e++)
                !function(e) {
                    ...
                    t ? new Cleave(e,_objectSpread(_objectSpread({}, r), {}, {
    ...
    function() {
        for (var e = document.querySelectorAll("[data-binded-content]"), t = (document.querySelectorAll("[data-scroll-binded]"),
        ...
        if (0 !== e.length)
            for (var t = 0; t < e.length; t++)
                e[t].addEventListener("click", function(e) {
                    ...
                    if (e.classList.toggle("all-checked"),
